    ...
    public class ProductosViewController : Controller
    {
        ...
        public async Task<IActionResult> Create(Producto producto, IFormFile imagenArchivo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var carpetaImages = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "images");
                    ...
                    var rutaCompleta = Path.Combine(carpetaImages, nombreUnico);
                ...
                {
                    producto.ImagenUrl = "/images/default-producto.png";
                }
